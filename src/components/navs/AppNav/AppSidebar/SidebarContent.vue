...
const ecosystemLinks = [
  { label: t('blog'), url: 'https://medium.com/@Dr.Bankruptcy' },
...
const socialLinks = [
  { component: 'TwitterIcon', url: 'https://twitter.com/lightingcove' },
  { component: 'DiscordIcon', url: 'https://discord.balancer.fi/' },
  { component: 'GithubIcon', url: 'https://github.com/lightingcove/' }
];
