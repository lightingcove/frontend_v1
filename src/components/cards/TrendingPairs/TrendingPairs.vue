  ...
  >
    <div class="trending-pairs">
      ...
      <div class="px-1 lg:p-3 flex flex-wrap gap-3">
        <button
          class="py-1 px-2 bg-transparent hover:bg-red-500 hover:text-white text-sm rounded-lg border dark:border-gray-800 font-medium lg:font-normal shadow-sm transition-colors"
